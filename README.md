...
See https://github.com/Dynmap/normalize.css
...
* Opera (last two)
* Safari 6+
* _[Normalize.css v1 provides legacy browser support](https://github.com/dynmap/normalize.css/tree/v1) (IE 6+, Safari 4+), but is no longer actively developed._
